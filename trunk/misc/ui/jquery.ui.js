...
$.extend($.datepicker._defaults, {
    'stepSeconds': 1, // Number of minutes to step up/down
...
Timepicker.prototype = {
    ...
    update: function (fd)
    {
        ...
        if (this._showSecond) {
            curTime += ':' + $('#' + this._mainDivId + ' span.fragSeconds').text();
        }
    ...
    _generateHtml: function ()
    {
        ...
        html += '<span class="fragHours">08</span><span class="delim">:</span><span class="fragMinutes">45</span>';
        if (this._showSecond) {
          html += '<span class="delim">:</span><span class="fragSeconds">45</span>';
        }
        html += '</div></div><table><tr><th>小时</th><th>分钟</th>';
        
        if (this._showSecond) {
          html += '<th>秒钟</th>';
        }
        html += '</tr><tr><td align="center"><div id="hourSlider" class="slider"></div></td><td align="center"><div id="minuteSlider" class="slider"></div></td>';
        if (this._showSecond) {
          html += '<td align="center"><div id="secondSlider" class="slider"></div></td>';
        }
        html += '</tr></table>';
